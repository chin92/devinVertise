...
<html>
<head>
    <title>Devins Advertising | Login </title>
...
<li><a class="color11" href="<?php echo base_url().'index.php/ctrl_contact'; ?>">Contact Us</a></li>
...
<div class="login">
    <div class="wrap">
        <div class="col_1_of_login span_1_of_login">
            ...
            <p>Create a new Account to purchase items and request quotaions</p>
            <div class="button1">
                <?= anchor('Register', 'Continue', 'class="button2"' ) ?>
               <!-- <a href="<?php /*echo base_url(). 'index.php/Register'; */?>"> <input type="submit" name="Submit" value="Continue"></a>-->
            </div>
            <div class="clear"></div>
        </div>
        <div class="col_1_of_login span_1_of_login">
                ...
                <div class="comments-area">
                    ...
                    <!--<form method="post" action="Login/validate_credentials">-->
                        ...
                        <p id="login-form-remember">
                            <label><a href="<?php echo base_url(). 'index.php/ResetPassword'; ?>">Forget Your Password ? </a></label>
                        </p>
                        <p>
...
<div class="footer-top">
    <div class="wrap">
        <div class="col_1_of_footer-top span_1_of_footer-top">
            <ul class="f_list">
                <li><img src="<?php echo base_url(); ?>images/f_icon.png" alt=""/><span class="delivery">Free delivery on all orders over 1000*</span></li>
            </ul>
        </div>
        <div class="col_1_of_footer-top span_1_of_footer-top">
            <ul class="f_list">
