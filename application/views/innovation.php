...
<html>
<head>
    <title>Devins Advertising | Innovation</title>
...
<div class="wrap">
<h4 class="title">Devin's Innovations</h4>

    <?php echo form_open_multipart('Innovation/index'); ?>
<form>
...
<div class="col_1_of_2 span_1_of_2">
    ...
    <div><input type="text" name="name" id="name" value="<?php echo $this->input->post('name');?>" placeholder="Name"></div>
    <div> <input type="text" name="description" id="description" value="<?php echo $this->input->post('description');?>" placeholder="Description"></div>
    <div><input type="text" name="quantity" id="quantity" value="<?php echo $this->input->post('quantity');?>" placeholder="quantity"></div>

    <div>
        <input type="file" class="what" value="" name="pic">
       <br>
        <br>
    ...
    <input type="hidden" name="fname" value="<?php
    foreach($results as $row) {
       echo $val = $row->first_name;
    }?>">

    <input type="hidden" name="lname" value="<?php
    foreach($results as $row) {
