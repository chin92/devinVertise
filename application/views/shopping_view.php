...
<head>
    ...
    <title>Devins : Online Store</title>
...
//                 <input type="hidden" name="cart[1][id]" value="1" />
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5" align="right"><input type="button" class ='fg-button teal' value="Clear Cart" onclick="clear_cart()"></td>
                                            </tr>

                                           <tr>
                                               <td></td>
                                               <td><?php //submit button. ?>
            ...
            <div class="col1">
                <div class="h_nav">
                    ...
                    <ul>
                        ...
                        <!--									<li><a href="shop.html">kids</a></li>-->
                        <!--									<li><a href="shop.html">brands</a></li>-->
                            <img src="<?php echo base_url(); ?>images/nav_img3.jpg" alt=""/>
                            </div>
                    </ul>
                </div>
                <div>
...
//
    ...
    $sql = mysql_query("select * from products WHERE category='Online'");
    ...
    ?>
        ...
        <div id='product_div'>
            ...
            <div id='info_product'>
                <div id='name'><?php echo $product_name; ?></div>
                <div id='desc'>  <?php echo $des; ?></div>
