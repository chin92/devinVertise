...
<div class="col_1_of_2 span_1_of_2">
    <div>
        ...
        foreach($results as $row) {
            $val = $row->first_name;
            echo "<input type='text' name='firstName' value='$val' disabled> ";
        }
        ?>
    </div>
    ...
    <div>  <?php
        foreach($results as $row) {
            $val = $row->last_name;
            echo "<input type='text' name='lastName'  value='$val' disabled> ";
        }
        ?>
    </div>
    <div><?php
        foreach($results as $row) {
            $val = $row->address;
            echo "<input type='text' name='address'  value='$val' disabled> ";
        }
        ?>
    </div>
    ...
    <div><?php
        foreach($results as $row) {
            $val = $row->dobirth;
            echo "<input type='text'  name='dob'  value='$val' disabled>";
        }
        ?>
    ...
    <div>
        ...
        <?= anchor('UpdateCustomerProfile/editDetails', 'Edit Profile', 'class="button2"' ) ?>
...
<div> <?php
    foreach($results as $row) {
        ...
        echo "<input type='text' name='email'  value='$val' disabled> ";
    }
    ?>
</div>
<div> <?php
    foreach($results as $row) {
        $val = $row->phone;
        echo "<input type='text' name='phone'  value='$val' disabled> ";
    }
    ?>
</div>
<div> <?php
    foreach($results as $row) {
        $val = $row->username;
        echo "<input type='text' name='username'  value='$val' disabled> ";
    }
    ?>
</div>
