...
<?php echo form_open('UpdateCustomerProfile/updateCustomer')
?>
<form>
...
<div class="col_1_of_2 span_1_of_2">
    <div>
        ...
        foreach($results as $row) {
            $val = $row->first_name;
            echo "<input type='text' name='firstName' value='$val' > ";
        }
        ?>
    </div>
    ...
    <div>  <?php
        foreach($results as $row) {
            $val = $row->last_name;
            echo "<input type='text' name='lastName'  value='$val' > ";
        }
        ?>
    </div>
    <div><?php
        foreach($results as $row) {
            $val = $row->address;
            echo "<input type='text' name='address'  value='$val' > ";
        }
        ?>
    </div>
    ...
    <div><?php
        foreach($results as $row) {
            $val = $row->dobirth;
            echo "<input type='text'  name='dob'  value='$val' >";
        }
        ?>
    ...
    <div>
     ...
     <!--   --><?/*= anchor('Register', 'Update Details', 'class="button2"' ) */?>
        <button class="grey">Update Profile</button>
...
<div> <?php
    foreach($results as $row) {
        $val = $row->phone;
        echo "<input type='text' name='phone'  value='$val' > ";
    }
    ?>
</div>
<div> <?php
