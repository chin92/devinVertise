...
$sql = mysql_query("select * from products WHERE category='Events'");
...
if ($productCount > 0) {
    while ($row = mysql_fetch_array($sql)) {
        ...
        <div class='col_1_of_single1 span_1_of_single1'><a href='viewAhotelWear?id=$id'>
            <div class='view1 view-fifth1'>
                <div class='top_box'>
                    <h3 class='m_1'>$product_name</h3>
                   <!-- <p class='m_2'>Lorem ipsum</p-->
                    <div class='grid_img'>
                        <div class='css3'><img  src='http://localhost/devinsadvertising/$image.jpg' alt=''/></div>
    <div class='mask1'>
...
<ul class='list2'>
    <li>
        <img src='http://localhost/devinsadvertising/images/plus.png' alt=''/>
    ...
    <div class="col_1_of_single1 span_1_of_single1"><a href="single.html">
            <div class="view1 view-fifth1">
                <div class="top_box">
                    ...
                    <p class="m_2">Lorem ipsum</p>
                    <div class="grid_img">
                        <div class="css3"><img src="<?php /*echo base_url(); */?>images/pic3.jpg" alt=""/></div>
                        <div class="mask1">
                            <div class="info">Quick View</div>
                        </div>
                    </div>
            ...
            <ul class="list2">
                <li>
                    <img src="<?php /*echo base_url(); */?>images/plus.png" alt=""/>
                    <ul class="icon1 sub-icon1 profile_img">
                        <li><a class="active-icon c1" href="#">Add To Bag </a>
                            <ul class="sub-icon1 list">
    ...
    <div class="col_1_of_single1 span_1_of_single1"><a href="single.html">
            <div class="view1 view-fifth1">
                <div class="top_box">
                    ...
                    <p class="m_2">Lorem ipsum</p>
                    <div class="grid_img">
                        <div class="css3"><img src="<?php /*echo base_url(); */?>images/pic4.jpg" alt=""/></div>
                        <div class="mask1">
                            <div class="info">Quick View</div>
                        </div>
                    </div>
    ...
    <div class="col_1_of_single1 span_1_of_single1"><a href="single.html">
            <div class="view1 view-fifth1">
                <div class="top_box">
                    ...
                    <p class="m_2">Lorem ipsum</p>
                    <div class="grid_img">
                        <div class="css3"><img src="<?php /*echo base_url(); */?>images/pic5.jpg" alt=""/></div>
                        <div class="mask1">
                            <div class="info">Quick View</div>
                        </div>
                    </div>
    ...
    <div class="col_1_of_single1 span_1_of_single1"><a href="single.html">
            <div class="view1 view-fifth1">
                <div class="top_box">
                    ...
                    <p class="m_2">Lorem ipsum</p>
                    <div class="grid_img">
                        <div class="css3"><img src="<?php /*echo base_url(); */?>images/pic6.jpg" alt=""/></div>
                        <div class="mask1">
                            <div class="info">Quick View</div>
                        </div>
                    </div>
    ...
    <div class="col_1_of_single1 span_1_of_single1"><a href="single.html">
            <div class="view1 view-fifth1">
                <div class="top_box">
                    ...
                    <p class="m_2">Lorem ipsum</p>
                    <div class="grid_img">
                        <div class="css3"><img src="<?php /*echo base_url(); */?>images/pic7.jpg" alt=""/></div>
                        <div class="mask1">
                            <div class="info">Quick View</div>
                        </div>
                    </div>
    ...
    <div class="col_1_of_single1 span_1_of_single1"><a href="single.html">
            <div class="view1 view-fifth1">
                <div class="top_box">
                    ...
                    <p class="m_2">Lorem ipsum</p>
                    <div class="grid_img">
                        <div class="css3"><img src="<?php /*echo base_url(); */?>images/pic8.jpg" alt=""/></div>
                        <div class="mask1">
                            <div class="info">Quick View</div>
                        </div>
                    </div>
    ...
    <div class="col_1_of_single1 span_1_of_single1"><a href="single.html">
            <div class="view1 view-fifth1">
                <div class="top_box">
                    ...
                    <p class="m_2">Lorem ipsum</p>
                    <div class="grid_img">
                        <div class="css3"><img src="<?php /*echo base_url(); */?>images/pic2.jpg" alt=""/></div>
                        <div class="mask1">
                            <div class="info">Quick View</div>
                        </div>
                    </div>
    ...
    <div class="col_1_of_single1 span_1_of_single1"><a href="single.html">
            <div class="view1 view-fifth1">
                <div class="top_box">
                    ...
                    <p class="m_2">Lorem ipsum</p>
                    <div class="grid_img">
                        <div class="css3"><img src="<?php /*echo base_url(); */?>images/pic1.jpg" alt=""/></div>
                        <div class="mask1">
                            <div class="info">Quick View</div>
                        </div>
                    </div>
    ...
    <div class="col_1_of_single1 span_1_of_single1"><a href="single.html">
            <div class="view1 view-fifth1">
                <div class="top_box">
                    ...
                    <p class="m_2">Lorem ipsum</p>
                    <div class="grid_img">
                        <div class="css3"><img src="<?php /*echo base_url(); */?>images/pic.jpg" alt=""/></div>
                        <div class="mask1">
                            <div class="info">Quick View</div>
                        </div>
                    </div>
