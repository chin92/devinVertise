...
if (isset($_GET['id'])) {
    ...
    //where the id cannot be changed to string..only integer
    ...
    <div class="wrap">
        ...
        <div class="cssmenu">
            <ul>
                ...
                <li><a href="checkout.html">Store Locator</a></li>
...
<div class="cont span_2_of_3">
        ...
        <ul id="etalage">
            <li>
                <a href="optionallink.html">
                    ...
                    <img class="etalage_thumb_image" src="<?php  echo base_url(). $image; ?>.jpg" alt="<?php $product_name ?>"/>
                    <img class="etalage_source_image" src="<?php  echo base_url(). $image; ?>.jpg"/>
                   <!-- <img class="etalage_thumb_image" src="<?php /*echo base_url(); */?>images/t1.jpg" />
                    <img class="etalage_source_image" src="<?php /*echo base_url(); */?>images/t2.jpg" />-->
                </a>
            </li>
         <!--   <li>
                <img class="etalage_thumb_image" src="<?php /*echo base_url(); */?>images/t2.jpg" />
                <img class="etalage_source_image" src="<?php /*echo base_url(); */?>images/t2.jpg" />
            </li>
            <li>
                <img class="etalage_thumb_image" src="<?php /*echo base_url(); */?>images/t3.jpg" />
                <img class="etalage_source_image" src="<?php /*echo base_url(); */?>images/t3.jpg" />
            </li>
            <li>
                <img class="etalage_thumb_image" src="<?php /*echo base_url(); */?>images/t4.jpg" />
                <img class="etalage_source_image" src="<?php /*echo base_url(); */?>images/t4.jpg" />
            </li>
            <li>
                <img class="etalage_thumb_image" src="<?php /*echo base_url(); */?>images/t5.jpg" />
                <img class="etalage_source_image" src="<?php /*echo base_url(); */?>images/t5.jpg" />
            </li>
            <li>
                <img class="etalage_thumb_image" src="<?php /*echo base_url(); */?>images/t6.jpg" />
                <img class="etalage_source_image" src="<?php /*echo base_url(); */?>images/t6.jpg" />
            </li>
            <li>
                <img class="etalage_thumb_image" src="<?php /*echo base_url(); */?>images/t1.jpg" />
                <img class="etalage_source_image" src="<?php /*echo base_url(); */?>images/t1.jpg" />
            </li>-->
        </ul>
    ...
    <div class="cont1 span_2_of_a1">
        ...
        <div class="price_single">
            <span class="reducedfrom1"><?php echo $price; ?></span>
          <!--  <span class="actual">$12.00</span><a href="#">click for offer</a>-->
        </div>
        <ul class="options">
            <h4 class="m_9">Quantity</h4> <input type="text" name="qua" id='quantity' value='1'  style="height: 30px;width: 40px" onblur="isValid()"/>

            <div class="clear"></div>
        </ul>
        <div class="btn_form">
            <form>
                <input type="submit" value="request quotation" title="">
            </form>
        </div>
        <ul class="add-to-links">
            <li><img src="<?php echo base_url(); ?>images/wish.png" alt=""/><a href="#">Add to wishlist</a></li>
        </ul>
        <p class="m_desc"><?php echo $details; ?></p>
    ...
    <!--<ul id="flexiselDemo3">
        <li><img src="<?php /*echo base_url(); */?>images/pic11.jpg" /><div class="grid-flex"><a href="#">Bloch</a><p>Rs 850</p></div></li>
        <li><img src="<?php /*echo base_url(); */?>images/pic10.jpg" /><div class="grid-flex"><a href="#">Capzio</a><p>Rs 850</p></div></li>
        <li><img src="<?php /*echo base_url(); */?>images/pic9.jpg" /><div class="grid-flex"><a href="#">Zumba</a><p>Rs 850</p></div></li>
        <li><img src="<?php /*echo base_url(); */?>images/pic8.jpg" /><div class="grid-flex"><a href="#">Bloch</a><p>Rs 850</p></div></li>
        <li><img src="<?php /*echo base_url(); */?>images/pic7.jpg" /><div class="grid-flex"><a href="#">Capzio</a><p>Rs 850</p></div></li>
    </ul>-->
    <script type="text/javascript">
